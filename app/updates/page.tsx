          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              <article className="flex h-full flex-col rounded-2xl border border-slate-700 bg-slate-800 p-7 shadow-lg transition group-hover:border-yellow-400">
                ...
                <h2 className="text-2xl font-bold leading-tight text-white">
                  Navy Veteran&apos;s Third-Party Congressional Bid Tackles VA
                  Benefits, Mental Health
                </h2>

                <p className="mt-4 flex-1 leading-7 text-gray-300">
                  Military.com profiles Brian Lambert&apos;s campaign and his
                  focus on veterans&apos; earned benefits, VA accountability,
                  and the veteran mental-health crisis.
                </p>
            ...
            >
              <article className="flex h-full flex-col rounded-2xl border border-slate-700 bg-slate-800 p-7 shadow-lg transition group-hover:border-yellow-400">
                ...
                <h2 className="text-2xl font-bold leading-tight text-white">
                  Navy Veteran Brian Lambert Launches Congressional Bid in
                  Florida’s 14th District
                </h2>

                <p className="mt-4 flex-1 leading-7 text-gray-300">
                  Tampa Free Press covers Brian Lambert&apos;s campaign launch,
                  Navy service, constitutional platform, commitment to
                  accountability, and advocacy for veterans.
                </p>
